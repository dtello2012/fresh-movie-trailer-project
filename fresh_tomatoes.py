...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap-theme.min.css" integrity="sha384-rHyoN1iRsVXV4nD0JutlnGaslCJuC7uwjduW9SVrLvRYooPp2bWYgmgJQIXwl/Sp" crossorigin="anonymous">
    ...
    <style type="text/css" media="screen">
        ...
        h1 i.glyphicon-menu-right {
            font-size: 50%;
            top: -3px !important;
            font-weight: 300;
        }
        .movie-tile .card:hover {
  ...
  <body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h1>
                    <i class="glyphicon glyphicon-film"></i> <i class="glyphicon glyphicon-menu-right"></i> Favorites
                </h1>
            </div>
        </div>
    </div>
